    ...
    <section className="w-full py-20">
      ...
      <div className="my-20 flex flex-col lg:flex-row items-center justify-center w-full gap-4">
        ...
        <Card
          ...
          des="This is where the magic happens! Based on the approved design, I'll translate everything into a functional cloud environment, 
          deploying your applications and services while ensuring optimal performance and security."
        >
          <CanvasRevealEffect
            animationSpeed={3}
